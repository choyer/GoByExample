// Starting with Go version 1.18, support for
// _generics_, also known as _type paramters_ has
// been added.
...
// `==` and `!=` operators. For a more thorough explaination
...
// parameters in place. The type `List[T]`, not `List`.
...
func main() {
	...
	// specify the types for `S` and `E` when calling
	// `SlicesIndex` - the compiler infers them
	// automatically.
	fmt.Println("index of zoo:", SlicesIndex(s, "zoo"))

	// ... though we could also specify them explicity.
