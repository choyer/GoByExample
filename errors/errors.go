...
// the exceptions used in languages such as Java, Python
// and Ruby and the overloaded single result / error value
...
func f(arg int) (int, error) {
	...
	// A `nil` value in the rror position indicates that
	// there was NO error.
	return arg + 3, nil
}
