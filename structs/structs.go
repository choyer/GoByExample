...
func main() {
	...
	// You can name the fields when intializing a struct.
	...
	// an anonymous struct type. This technique is commonly
	// used for [table-driven tests](testing-and-benchmarking).
	dog := struct {
		name   string
		isGood bool
	}{
